...
func (c ChainCmd) AddKeyCommand(accountName, coinType, algo string) step.Option {
	command := []string{
		commandKeys,
		"add",
		accountName,
...
func (c ChainCmd) RecoverKeyCommand(accountName, coinType, algo string) step.Option {
	command := []string{
		commandKeys,
		"add",
		accountName,
